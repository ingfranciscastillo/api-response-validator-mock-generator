import { pgTable, serial, text, timestamp, integer, boolean, pgEnum, uniqueIndex, index } from 'drizzle-orm/pg-core'
...
export const organizationInvitation = pgTable('organization_invitations', {
  id: text('id').primaryKey(),
  organizationId: text('organization_id').notNull().references(() => organization.id, { onDelete: 'cascade' }),
